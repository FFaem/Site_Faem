    ...
    <div className="bg-gray-100 dark:bg-black">
      ...
      <div className="mx-auto max-w-7xl py-3 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <button className="text-sm dark:text-white">A-</button>
            <button className="text-base font-semibold dark:text-white">100%</button>
            <button className="text-lg dark:text-white">A+</button>
            <Theme/>
          </div>
      ...
      <div className="bg-white py-4">
        <div className="mx-auto max-w-7xl flex justify-between items-center px-4 sm:px-6 lg:px-8">
          ...
          <img alt="Logo" className="h-12  " src="/logos/logo preto.png "/>
          <Button className="sm:hidden bg-green-500 h-8 w-32 rounded-3xl text-white dark:text-black">
            Inscreva-se
          </Button>

          {/* Conteúdo do menu mobile */}
          {isMenuOpen && (
            <div className="absolute inset-0 transform translate-x-0 transition duration-500 ease-in-out">
